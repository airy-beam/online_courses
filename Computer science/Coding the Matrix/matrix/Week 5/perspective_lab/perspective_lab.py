...
## Task 3
r = []
r.extend( make_equations(358,36, 0,0) )
r.extend( make_equations(329,597, 0,1) )
r.extend( make_equations(592,157, 1,0) )
r.extend( make_equations(580,483, 1,1) )
domain = {(a, b) for a in {'y1', 'y2', 'y3'} for b in {'x1', 'x2', 'x3'}}
...
def mat_move2board(Y):
    ...
    Y_c = mat2coldict(Y)
    for v in Y_c.values():
        cols.append( Vec({'y1','y2','y3'}, { 'y1': v['y1'] / v['y3'] , 'y2': v['y2'] / v['y3'] , 'y3': 1 }) )
